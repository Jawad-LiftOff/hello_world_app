...
@router.post(
    "/compare-with-folder/",
    summary="Compare Image With Reference Folder",
    description="Upload an image (e.g., from your camera). The API will compare it with all images in the reference_pictures folder and return the best match."
)
async def compare_with_folder(
    ...
    Returns the best match (if any) with confidence and filename.
    """
